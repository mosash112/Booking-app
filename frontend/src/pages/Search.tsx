...
const Search = () => {
    ...
    const searchParams = {
        ...
        childCound: search.childCound.toString(),
        page: page.toString(),
        stars: selectedStars,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-5">
            <div className="rounded-lg border border-slate-300 p-5 h-fit sticky top-10">
                <div className="space-y-5">
                    ...
                    <StarRatingFilter seletedStars={selectedStars} onChange={handleStarsChange} />
                    <HotelTypesFilter seletedHotelTypes={selectedHotelTypes} onChange={handleHotelTypeChange} />
                    <FacilitiesFilter seletedFacilities={selectedFacilities} onChange={handleFacilityChange} />
                    <PriceFilter seletedPrice={selectedPrice} onChange={(value?: number) => setSelectedPrice(value)} />
                </div>
            </div>
